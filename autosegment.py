import numpy as np
from modelfunctions import freeze, segmentation, segexport, knnmodel, rfmtoday, segfind, statsexport, selectexport
...
#run model functions
rfmfrz=freeze(fname,keycode,maildate,features,idtype,target)
