...
quarter[ (arr1['date']>=np.datetime64('2023-01-01')) & (arr1['date']<=np.datetime64('2023-03-31'))]=1
quarter[ (arr1['date']>=np.datetime64('2023-04-01')) & (arr1['date']<=np.datetime64('2023-06-30'))]=2
quarter[ (arr1['date']>=np.datetime64('2023-07-01')) & (arr1['date']<=np.datetime64('2023-09-30'))]=3
quarter[ (arr1['date']>=np.datetime64('2023-10-01')) & (arr1['date']<=np.datetime64('2023-12-31'))]=4
...
def init():
    ...
    ax.legend(custom_lines,['Quarter1','Quarter2','Quarter3','Quarter4'],loc='lower right')
...
with open("/home/dfowler/documents/scatter.html", "w") as f:
...
axes.set_xlim(np.datetime64('2023-01-01'), np.max(arr1['date']).astype('datetime64[D]'))
...
with open("/home/dfowler/documents/line.html", "w") as f:
    print(anim.to_html5_video(), file=f)
